...
def _iterative_unlearn_impl(unlearn_iter_func):
    def _wrapped(data_loaders, bottom_model_A, bottom_model_B, top_model, criterion, class_to_forget, args):
        ...
        for epoch in range(args.unlearn_epochs):
            ...
            train_acc = unlearn_iter_func(
                data_loaders, bottom_model_A, bottom_model_B, top_model, criterion, class_to_forget, bottom_model_A_optimizer, bottom_model_B_optimizer, top_model_optimizer, epoch, args)
